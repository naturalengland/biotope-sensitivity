...
## This is the main script which runs the support functions, sequentially, making objects available to coming/sequential functions
...
#temporary output folder - not permanent! files here will automatically be deleted!
folder <- "tmp_output/"
...
# final output folder for GIS geopackage
final_output <- "output"
...
layer.name <- "sensitivity_fishing_ops" # name of layer being put
