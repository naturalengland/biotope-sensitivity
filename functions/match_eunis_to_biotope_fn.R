...
match_eunis_to_biotopes_fn <- function(x, y, high.lvl) {
        ...
        for (h in seq_along(y)) {
                ...
                for (k in seq_along(y.dfs.lst)) {
                        ...
                        write.csv(result.tbl,paste0("./output/sbgr_biotp_eunis_match/subBGR_",sBGR,"_match_biotope_eunis_high_",high.lvl,"_eunis_mapped_",low.lvl,".csv")) # stores the result as a csv
